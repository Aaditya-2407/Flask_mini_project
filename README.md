...
Step 3: Install DependenciesWith the environment active, 
install the required libraries:Bashpip 
          install -r requirements.txt


Step 4: Configure Environment VariablesThe application requires an API key to communicate with the AI.Create a file named .env in the root folder.Visit Google AI Studio to get a free Gemini API Key.Add the following line to your 
.env file:
